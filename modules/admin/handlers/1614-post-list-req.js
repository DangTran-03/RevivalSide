...
module.exports = {
  ...
  handle(ctx, socket, packet) {
    ...
    if (replay && !replay.bootPostListTemplateSent && !replay.postLobbyBootTemplateSent) {
      // Official boot emits shop/raid/mission/achievement notices around POST_LIST_REQ.
      // Keep replay disabled, but preserve those prompt notifies.
